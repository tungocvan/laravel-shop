...
abstract class RequestDraftTestCase extends TestCase
{
    ...
    protected function publishedType(int $actorId, array $schema, ?int $audienceUserId = null, ?array $stages = null): RequestType
    {
        ...
        app(SaveTypeDraft::class)->handle($type, [
            ...
            'stages' => $stages ?? [['stage_key' => 'approval', 'name' => 'Approval', 'position' => 1, 'mode' => 'single', 'resolver_key' => 'fixed_users', 'resolver_config_json' => ['user_ids' => [$actorId]], 'allow_reassignment' => false]],
        ], $actorId, 1);
