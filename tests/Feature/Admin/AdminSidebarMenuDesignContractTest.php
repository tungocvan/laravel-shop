...
class AdminSidebarMenuDesignContractTest extends TestCase
{
    ...
    public function test_parent_group_uses_menu_active_state_while_open_and_child_keeps_child_palette(): void
    {
        ...
        $this->assertStringContainsString("open ? 'var(--admin-sidebar-active-title-color)'",$group);
        $this->assertStringContainsString("open ? 'var(--admin-sidebar-active-icon-color)'",$group);
    ...
    {
        $sidebar=file_get_contents(base_path('Modules/Admin/resources/views/livewire/partials/sidebar.blade.php'));$item=file_get_contents(base_path('Modules/Admin/resources/views/livewire/partials/sidebar/navigation/item.blade.php'));$group=file_get_contents(base_path('Modules/Admin/resources/views/livewire/partials/sidebar/navigation/group.blade.php'));
