...
class MuasamcongClientSearchTest extends TestCase
{
    ...
    public function test_client_search_reuses_service_and_applies_admin_style_filters_and_price_sort(): void
    {
        ...
        $registry = Mockery::mock(ClientApplicationRegistry::class);
        ...
        $view = (new MuasamcongClientController())->drugPricing(
            $request,
            $service,
            $snapshots,
            $syncService,
    ...
    {
        $definitions = app(ClientApplicationPermissionService::class)->definitions()->pluck('name');
