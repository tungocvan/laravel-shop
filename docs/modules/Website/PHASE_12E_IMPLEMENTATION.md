...
`/manifest.webmanifest` remains the Client Portal manifest. Storefront uses `/website-manifest.webmanifest`; Phase 12E does not overwrite the Client Portal PWA contract.
