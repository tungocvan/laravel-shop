...
class ModuleServiceProvider extends ServiceProvider
{
    ...
    {
        $modules = $this->app->make(ModuleRegistry::class)->boot();

        $enabledModules = $modules->filter(fn (array $module): bool => $module['enabled']);
    ...
    private function registerConsole(array $module): void
    {
        ...
        foreach (File::allFiles($consolePath) as $file) {
            ...
            if (is_subclass_of($fullClass, Command::class)) {
                $commands[] = $fullClass;
            }
        }
