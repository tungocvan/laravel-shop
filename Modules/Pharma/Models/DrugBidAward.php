...
class DrugBidAward extends Model
{
    ...
    protected $fillable = [
        'canonical_identity_key', 'medicine_id', 'medicine_code', 'medicine_match_status',
        'medicine_name', 'active_ingredient', 'concentration', 'route', 'dosage_form', 'unit',
        'drug_group', 'packaging_specification', 'shelf_life_months', 'registration_or_import_license',
        'manufacturer', 'country', 'quantity', 'price_plan', 'winning_price', 'amount', 'unit_price',
        'bidding_notice_code', 'lot_no', 'lot_name', 'investor_code', 'investor_name', 'decision_number',
    ...
    protected $casts = [
        'medicine_id' => 'integer', 'quantity' => 'decimal:4', 'price_plan' => 'decimal:4',
    ...
    {
        $hsspMap = [
            'medicine_name' => 'name', 'active_ingredient' => 'active_ingredients',
            'concentration' => 'concentration', 'route' => 'route_of_administration',
            'dosage_form' => 'dosage_form', 'unit' => 'unit',
