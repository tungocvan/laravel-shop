...
<section class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <div class="rounded-xl border border-slate-200 bg-slate-50 p-4">
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-slate-600">{{ $group['assignments'] }} phân công · {{ $group['hospitals'] }} bệnh viện</p>
                    </div>
    ...
    <div class="mt-5 rounded-2xl border border-indigo-200 bg-indigo-50/60 p-4">
        <p class="text-sm font-bold text-indigo-950">Phân công hàng loạt</p>
        <p class="mt-1 text-sm text-indigo-800">Chọn User rồi gán cho toàn bộ các cặp Bệnh viện × Sản phẩm đang có phân bổ thực tế. Không tạo phân công giả cho sản phẩm chưa phân bổ.</p>
        <div class="mt-3 grid gap-3 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_auto] lg:items-end">
