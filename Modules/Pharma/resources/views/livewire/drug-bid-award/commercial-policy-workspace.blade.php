...
<section class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
    ...
    <div class="mt-4 overflow-x-auto">
        <table class="min-w-[850px] w-full divide-y divide-slate-200 text-sm">
            <thead class="bg-slate-50 text-xs uppercase text-slate-600"><tr><th class="px-3 py-3 text-left">Chọn</th><th class="px-3 py-3 text-left">Sản phẩm / Mã hàng</th><th class="px-3 py-3 text-right">SL trúng</th><th class="px-3 py-3 text-right">Đã phân bổ</th><th class="px-3 py-3 text-left">Chính sách (%)</th></tr></thead>
    ...
    @if($canManage)<div class="mt-4 flex justify-end"><button wire:click="saveProductPolicies" class="min-h-11 rounded-xl bg-indigo-600 px-5 text-sm font-semibold text-white">Lưu chính sách sản phẩm</button></div>@endif
</section>
...
<section class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
    ...
    <div class="mt-4 overflow-x-auto">
        <table class="min-w-[850px] w-full divide-y divide-slate-200 text-sm">
            <thead class="bg-slate-50 text-xs uppercase text-slate-600"><tr><th class="px-3 py-3 text-left">Sản phẩm</th><th class="px-3 py-3 text-left">Chính sách</th><th class="px-3 py-3 text-left">User đang quản lý</th><th class="px-3 py-3 text-right">Thao tác</th></tr></thead>
            <tbody class="divide-y divide-slate-100">
            @foreach($products as $product)
