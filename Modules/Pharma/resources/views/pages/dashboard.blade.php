    ...
    <div class="space-y-8">
        ...
        <section>
            ...
            <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                <a href="{{ route('admin.pharma.inventory.index') }}" class="rounded-2xl border border-teal-200 bg-teal-50/60 p-5 hover:border-teal-400"><p class="text-xs font-semibold uppercase tracking-wide text-teal-700">Inventory</p><h3 class="mt-2 text-lg font-bold text-slate-950">Tồn kho Pharma</h3><p class="mt-2 text-sm leading-6 text-slate-600">Quản lý tồn theo mã thuốc, số lô, hạn dùng; lập phiếu nhập/xuất và ghi sổ biến động.</p></a>
