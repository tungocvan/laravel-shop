...
<td style="width: {{ $signatureWidth }}%">{{ $signature['label'] }}@if($signature['receiver'])<br><span class="muted small">Ngày ..... tháng ..... năm .....</span>@endif<br><span class="muted small">(Ký, ghi rõ họ tên)</span><div class="space"></div></td>
@endforeach
</tr></table>
@endif
