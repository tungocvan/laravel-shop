...
@media print{.toolbar{display:none}}body{background:#eee}.sheet{max-width:210mm;margin:12px auto;background:#fff;padding:14mm;box-sizing:border-box}.toolbar{max-width:210mm;margin:12px auto;text-align:right}</style></head><body><div class="toolbar"><button onclick="window.print()">In phiếu nhập</button></div><div class="sheet">
@php
