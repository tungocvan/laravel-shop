@if(data_get($websiteFeatures ?? [], 'back_to_top', true))
    ...
    <button x-data="{ show: false }"
            ...
            class="fixed bottom-8 z-40 p-3 rounded-full bg-blue-600 text-white shadow-xl hover:bg-blue-700 hover:-translate-y-1 transition-all duration-300 {{ $backToTopPosition === 'bottom-left' ? 'left-8' : 'right-8' }}"
            style="display: none;">
