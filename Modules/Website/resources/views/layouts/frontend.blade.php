...
<body class="text-website-text font-website-body antialiased flex flex-col min-h-screen">
    ...
    <main id="main-content" tabindex="-1" class="website-main-shell flex-grow">
