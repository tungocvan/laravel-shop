<div class="container mx-auto px-4 mb-24">
                        ...
                        <div class="flex flex-col gap-4">
                            <div class="relative group">
                                <input type="email"
                                       ...
                                       class="w-full pl-6 pr-4 py-5 rounded-2xl bg-white/5 border border-white/10 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white/10 transition-all duration-300 backdrop-blur-sm @error('email') border-red-500 ring-1 ring-red-500 @enderror">
    ...
    {{-- CSS phải nằm bên trong root element duy nhất của Livewire component. --}}
    <style>
        @keyframes blob {
