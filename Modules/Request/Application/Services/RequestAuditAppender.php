...
{
    public function append(string $aggregateType, string $aggregatePublicId, string $eventKey, int $actorId, string $correlationId, array $context = [], ?string $idempotencyKeyHash = null): RequestAuditEvent
    {
