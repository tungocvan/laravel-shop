...
class RequestStageDefinition extends Model
{
    ...
    protected $fillable = ['request_type_version_id', 'stage_key', 'name', 'position', 'mode', 'resolver_key', 'resolver_config_json', 'instructions', 'allow_reassignment'];

    protected function casts(): array
    {
        return ['position' => 'integer', 'mode' => StageMode::class, 'resolver_config_json' => 'array', 'allow_reassignment' => 'boolean'];
    }
