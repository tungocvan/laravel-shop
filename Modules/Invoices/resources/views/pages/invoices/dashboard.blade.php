    ...
    <div class="space-y-7">
        ...
        <section aria-labelledby="classification-kpi-heading" class="rounded-2xl border border-amber-200 bg-amber-50/30 p-5 shadow-sm sm:p-6">
            <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                <div class="min-w-0"><p class="text-xs font-semibold uppercase tracking-wide text-amber-700">Phân tích mua vào · năm {{ $classificationYear }}</p><h2 id="classification-kpi-heading" class="mt-1 text-lg font-bold text-slate-950">Cơ cấu hàng hóa & chi phí</h2><p class="mt-1 text-sm text-slate-600">Giá trị chưa VAT · theo ngày phát hành hóa đơn · 01/01/{{ $classificationYear }}–31/12/{{ $classificationYear }}. VAT được theo dõi riêng, không tự động xem là chi phí.</p></div>
