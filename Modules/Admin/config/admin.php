    ...
    'design' => [
        ...
        'sidebar_menu' => [
            'item' => [
                ...
                'title_color' => 'slate-900', 'icon_color' => 'slate-400',
                'background_mode' => 'transparent', 'background_color' => 'slate-50',
                'icon_background_mode' => 'transparent', 'icon_background_color' => 'slate-100',
                'hover_background_mode' => 'color', 'hover_background_color' => 'slate-100',
                'hover_title_color' => 'slate-900', 'hover_icon_color' => 'indigo-600',
                'icon_size' => '20', 'item_height' => '44', 'padding_x' => '12', 'padding_y' => '8', 'content_gap' => '12', 'item_gap' => '4',
            ],
            'submenu' => [
                'font_family' => 'inherit', 'font_size' => '13', 'font_weight' => 'normal',
                'title_color' => 'slate-500', 'icon_color' => 'slate-400',
                'background_mode' => 'transparent', 'background_color' => 'slate-50',
                'hover_background_mode' => 'color', 'hover_background_color' => 'slate-100', 'hover_title_color' => 'slate-700',
                'active_background_mode' => 'color', 'active_background_color' => 'indigo-100', 'active_title_color' => 'indigo-600',
                'indent' => '28', 'item_height' => '36', 'padding_x' => '12', 'padding_y' => '6', 'offset' => '12', 'item_gap' => '2',
            ],
            'group' => ['gap' => '4'],
            'active' => [
                'title_color' => 'white', 'icon_color' => 'white', 'font_weight' => 'semibold',
                'menu_background_mode' => 'color', 'menu_background_color' => 'indigo-600',
                'menu_border_color' => 'indigo-600', 'menu_border_width' => '0', 'menu_border_style' => 'solid',
                'submenu_border_color' => 'indigo-600', 'submenu_border_width' => '0', 'submenu_border_style' => 'solid',
            ],
        ],
        'spacing' => ['tight' => '2', 'control' => '3', 'content' => '4', 'section' => '6'],
        'radius' => ['control' => 'lg', 'panel' => 'lg', 'overlay' => 'xl'],
    ],
    'sidebar' => ['enabled' => true, 'expanded_width' => '256px', 'collapsed_width' => '80px', 'desktop_collapsible' => true, 'mobile_drawer' => true, 'persist_state' => true, 'show_footer_profile' => true, 'navigation_search_threshold' => 12, 'controls' => ['collapse_enabled' => true, 'fullscreen_enabled' => true], 'header' => ['enabled' => true, 'show_mark' => true, 'show_title' => true, 'title' => null, 'show_subtitle' => true, 'subtitle' => 'Không gian quản trị'], 'footer' => ['enabled' => true, 'show_avatar' => true, 'show_name' => true, 'show_subtitle' => true, 'subtitle' => 'Tài khoản quản trị'], 'search' => ['enabled' => true], 'presentation' => ['background' => 'theme', 'custom_background' => '#0f172a', 'custom_accent' => '#4f46e5']],
