...
return [
    ...
    'layout' => [
        ...
        'show_footer' => false,
        'spacing' => [
            'content_padding_x' => '6', 'content_padding_top' => '6', 'content_padding_bottom' => '8', 'section_gap' => '6', 'tablet_padding_x' => '5', 'mobile_padding_x' => '4',
        ],
    ...
    'sidebar' => [
        ...
        'controls' => ['collapse_enabled' => true, 'fullscreen_enabled' => true],
        'header' => ['enabled' => true, 'show_mark' => true, 'show_title' => true, 'title' => null, 'show_subtitle' => true, 'subtitle' => 'Không gian quản trị'],
        'footer' => ['enabled' => true, 'show_avatar' => true, 'show_name' => true, 'show_subtitle' => true, 'subtitle' => 'Tài khoản quản trị'],
        'search' => ['enabled' => true],
        'presentation' => ['background' => 'theme'],
    ],
    'header' => [
        'height' => '4rem', 'sticky' => true, 'search' => true, 'notifications' => true, 'theme_switcher' => false, 'user_menu' => true, 'mobile_search_mode' => 'overlay',
        'brand' => ['enabled' => true, 'logo' => null, 'logo_size' => '32', 'show_title' => true, 'title' => null, 'show_subtitle' => false, 'subtitle' => null, 'url' => '/admin'],
        'user_menu_config' => ['show_avatar' => true, 'show_name' => true, 'show_email' => true, 'show_role' => false, 'items' => []],
        'actions' => ['items' => [], 'mobile_overflow' => true],
        'presentation' => ['mode' => 'balanced', 'padding_x' => '6', 'action_gap' => '2', 'background' => 'system', 'divider' => 'subtle', 'shadow' => 'subtle', 'backdrop_blur' => true],
        'responsive' => ['mobile_brand' => 'logo-only', 'hide_title_on_mobile' => true, 'overflow_secondary_actions' => true],
    ],
    'footer' => [
        'show_app_name' => true,
        'copyright' => ['enabled' => true, 'owner' => null, 'url' => null, 'start_year' => null],
        'datetime' => ['show_date' => true, 'show_time' => true, 'date_format' => 'd/m/Y', 'time_format' => 'H:i:s'],
        'presentation' => ['alignment' => 'split', 'background' => 'system', 'divider' => 'subtle', 'compact' => true],
    ],
