    ...
    @if (! empty($selectedMenus))
        <div class="mb-6 rounded-xl border border-indigo-200 bg-indigo-50 p-4">
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <span class="text-sm font-medium text-indigo-800">Đã chọn {{ count($selectedMenus) }} menu trong phạm vi bộ lọc hiện tại</span>
                <div class="flex flex-wrap gap-2">
