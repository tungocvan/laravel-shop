<div class="space-y-5">
        ...
        <div class="rounded-xl border border-gray-200 bg-white shadow-sm">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 text-sm">
                    ...
                    <tr>
                        <th class="px-4 py-3"></th><th class="px-4 py-3">Mã TBMT</th><th class="px-4 py-3">Tên gói thầu</th><th class="px-4 py-3">Ngày</th><th class="px-4 py-3">Năm</th><th class="px-4 py-3">Trạng thái</th><th class="px-4 py-3"></th>
                    </tr>
                    </thead>
                    ...
                    @forelse ($results as $row)
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3">
                                @if ($isSynced)<span class="rounded-full bg-emerald-50 px-2 py-1 text-xs font-medium text-emerald-700">Đã đồng bộ</span>@else<span class="rounded-full bg-amber-50 px-2 py-1 text-xs font-medium text-amber-700">Đã tham gia</span>@endif
                            </td>
                            <td class="px-4 py-3"><button wire:click="showDetail('{{ $row['notifyNo'] ?? '' }}')" class="text-sm font-medium text-indigo-600">Chi tiết</button></td>
                        </tr>
                    @empty
    ...
    @if ($detail)
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-gray-950/50 p-4" wire:click.self="closeDetail">
