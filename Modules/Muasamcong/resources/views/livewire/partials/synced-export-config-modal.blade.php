    ...
    <div class="fixed inset-0 z-[110] flex items-center justify-center bg-black/50 p-4" wire:click.self="closeExportConfig">
        <div class="w-full max-w-[1600px] overflow-hidden rounded-2xl bg-white shadow-2xl">
            <div class="flex items-start justify-between border-b border-gray-200 px-5 py-4">
                ...
                <button type="button" wire:click="closeExportConfig" class="rounded-lg border border-gray-200 px-3 py-1.5 text-gray-500">×</button>
            </div>
                        ...
                        <div class="rounded-xl border border-gray-200 bg-white p-4">
                            ...
                            <div class="mb-4 grid gap-4 md:grid-cols-2">
                                ...
                                <div class="rounded-xl border border-dashed border-violet-200 bg-violet-50/40 p-3">
                                    ...
                                    <p class="mt-1 text-[11px] text-gray-500">Nên dùng PNG nền trong suốt để chữ ký hiển thị đẹp trong Excel.</p>
            ...
            <div class="flex items-center justify-between border-t border-gray-200 bg-gray-50 px-5 py-4">
                <p class="text-xs text-gray-500">Footer 3 cột cuối: ngày ký → chức danh → chữ ký → họ tên người ký.</p>
