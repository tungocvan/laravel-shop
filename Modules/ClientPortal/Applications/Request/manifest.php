...
return [
    ...
    'quick_actions' => [
        'create' => [
            ...
            'permissions' => ['client.request.create.view', 'request.instance.create'],
            'icon' => 'plus-circle',
            'sort_order' => 10,
        ],
        'inbox' => [
            ...
            'permissions' => ['client.request.inbox.view', 'request.task.view'],
            'icon' => 'inbox',
            'sort_order' => 20,
        ],
    ],
    'navigation' => [
        ...
        'mine' => [
            ...
            'permissions' => ['client.request.mine.view', 'request.instance.view-own'],
            'icon' => 'document-text',
            'sort_order' => 30,
        ],
        'inbox' => [
        ...
        'processed' => [
            ...
            'permissions' => ['client.request.processed.view', 'request.task.view'],
            'icon' => 'check-circle',
            'placement' => 'more',
            'sort_order' => 50,
        ],
