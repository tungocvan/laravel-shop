    ...
    <div class="grid gap-4 lg:grid-cols-2">
        @forelse($applications as $app)
            <section class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
                ...
                <div class="mt-4 flex justify-end"><a href="{{ route('admin.client-apps.pwa.applications.edit', $app['key']) }}" class="rounded-lg border border-indigo-200 bg-indigo-50 px-3 py-2 text-xs font-semibold text-indigo-700">Giao diện Application & Feature →</a></div>
